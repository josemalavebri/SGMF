...
CREATE TABLE Movimiento (
  ...
  CONSTRAINT FK_Movimiento_TipoIngreso FOREIGN KEY (IdTipoIngreso) REFERENCES TipoIngreso (IdTipoIngreso),
  CONSTRAINT FK_Movimiento_CategoriaEgreso FOREIGN KEY (IdCategoriaEgreso) REFERENCES CategoriaEgreso (IdCategoriaEgreso)
);